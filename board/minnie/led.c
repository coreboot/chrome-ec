 ...
 *
 * Battery LED and Power LED control for minnie
 */
...
static void minnie_led_set_power(void)
{
...
static void minnie_led_set_battery(void)
{
...
static void led_second(void)
{
	if (led_auto_control_is_enabled(EC_LED_ID_POWER_LED))
		minnie_led_set_power();
	if (led_auto_control_is_enabled(EC_LED_ID_BATTERY_LED))
		minnie_led_set_battery();
}
