 ...
 */
#define PD_OPERATING_POWER_MW CONFIG_PLATFORM_EC_USB_PD_OPERATING_POWER_MW
#define PD_MAX_POWER_MW CONFIG_PLATFORM_EC_USB_PD_MAX_POWER_MW
#define PD_MAX_CURRENT_MA CONFIG_PLATFORM_EC_USB_PD_MAX_CURRENT_MA
#define PD_MAX_VOLTAGE_MV CONFIG_PLATFORM_EC_USB_PD_MAX_VOLTAGE_MV
