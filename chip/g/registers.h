...
#define   GINTSTS(bit)                BIT(GC_USB_GINTSTS_ ## bit ## _LSB)
#define GR_USB_GINTMSK                GR_USB_REG(GC_USB_GINTMSK_OFFSET)
#define   GINTMSK(bit)                BIT(GC_USB_GINTMSK_ ## bit ## MSK_LSB)
...
#define  DAINT_INEP(ep)               BIT((ep + GC_USB_DAINTMSK_INEPMSK0_LSB))
#define  DAINT_OUTEP(ep)              BIT((ep + GC_USB_DAINTMSK_OUTEPMSK0_LSB))
...
#define GAHBCFG_NP_TXF_EMP_LVL        BIT( GC_USB_GAHBCFG_NPTXFEMPLVL_LSB)
