...
const struct gpio_1p8v_t gpio_1p8v_ctrl[] = {
	{GPIO_A, BIT(4), &IT83XX_GPIO_GRC24, BIT(0)},
	{GPIO_A, BIT(5), &IT83XX_GPIO_GRC24, BIT(1)},
	{GPIO_B, BIT(3), &IT83XX_GPIO_GRC22, BIT(1)},
	{GPIO_B, BIT(4), &IT83XX_GPIO_GRC22, BIT(0)},
	{GPIO_B, BIT(5), &IT83XX_GPIO_GRC19, BIT(7)},
	{GPIO_B, BIT(6), &IT83XX_GPIO_GRC19, BIT(6)},
	{GPIO_C, BIT(1), &IT83XX_GPIO_GRC19, BIT(5)},
	{GPIO_C, BIT(2), &IT83XX_GPIO_GRC19, BIT(4)},
	{GPIO_C, BIT(7), &IT83XX_GPIO_GRC19, BIT(3)},
	{GPIO_D, BIT(0), &IT83XX_GPIO_GRC19, BIT(2)},
	{GPIO_D, BIT(1), &IT83XX_GPIO_GRC19, BIT(1)},
	{GPIO_D, BIT(2), &IT83XX_GPIO_GRC19, BIT(0)},
	{GPIO_D, BIT(3), &IT83XX_GPIO_GRC20, BIT(7)},
	{GPIO_D, BIT(4), &IT83XX_GPIO_GRC20, BIT(6)},
	{GPIO_E, BIT(0), &IT83XX_GPIO_GRC20, BIT(5)},
	{GPIO_E, BIT(6), &IT83XX_GPIO_GRC20, BIT(4)},
	{GPIO_E, BIT(7), &IT83XX_GPIO_GRC20, BIT(3)},
	{GPIO_F, BIT(2), &IT83XX_GPIO_GRC20, BIT(2)},
	{GPIO_F, BIT(3), &IT83XX_GPIO_GRC20, BIT(1)},
	{GPIO_F, BIT(4), &IT83XX_GPIO_GRC20, BIT(0)},
	{GPIO_F, BIT(5), &IT83XX_GPIO_GRC21, BIT(7)},
	{GPIO_F, BIT(6), &IT83XX_GPIO_GRC21, BIT(6)},
	{GPIO_F, BIT(7), &IT83XX_GPIO_GRC21, BIT(5)},
	{GPIO_H, BIT(0), &IT83XX_GPIO_GRC21, BIT(2)},
	{GPIO_H, BIT(1), &IT83XX_GPIO_GRC21, BIT(1)},
	{GPIO_H, BIT(2), &IT83XX_GPIO_GRC21, BIT(0)},
	{GPIO_I, BIT(1), &IT83XX_GPIO_GRC23, BIT(4)},
	{GPIO_I, BIT(2), &IT83XX_GPIO_GRC23, BIT(5)},
	{GPIO_I, BIT(3), &IT83XX_GPIO_GRC23, BIT(6)},
	{GPIO_I, BIT(4), &IT83XX_GPIO_GRC23, BIT(7)},
	{GPIO_J, BIT(0), &IT83XX_GPIO_GRC23, BIT(0)},
	{GPIO_J, BIT(1), &IT83XX_GPIO_GRC23, BIT(1)},
	{GPIO_J, BIT(2), &IT83XX_GPIO_GRC23, BIT(2)},
	{GPIO_J, BIT(3), &IT83XX_GPIO_GRC23, BIT(3)},
};
